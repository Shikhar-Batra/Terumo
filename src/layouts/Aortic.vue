<template>
    <div class="aortic-layout">
        <div class="primaryHeaderLogoWrapperLink">
            ...
            -->
            <a href="/aortic">
                <g-image src="~/terumo_aortic_logo.png" alt="Terumo CV Group" class="primaryHeaderLogo"></g-image>
            </a>&nbsp;
        </div>
        <header class="header">
            <!--      <strong>-->
...
<style scoped>
    ...
    .aortic-layout .primaryHeaderLogoWrapperLink{
        /*max-width: 1243px;*/
        margin-top: 10px;
